...
<aside id="mobile-drawer" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform -translate-x-full lg:translate-x-0 lg:static lg:flex lg:flex-col transition-transform duration-300 ease-in-out shadow-sm">
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <?php if (hasPermission('view_deliverables')): ?>
        <a href="/owner/deliverables/" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?= strpos($_SERVER['REQUEST_URI'], '/owner/deliverables/') !== false ? 'bg-primary text-white shadow-md shadow-primary/20 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
            <svg class="w-5 h-5 <?= strpos($_SERVER['REQUEST_URI'], '/owner/deliverables/') !== false ? 'text-white' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
            <span>Delivery Planner</span>
        </a>
        <?php endif; ?>

        <?php if (hasPermission('view_tasks')): ?>
        <a href="/owner/tasks/" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 <?= strpos($_SERVER['REQUEST_URI'], '/owner/tasks/') !== false ? 'bg-primary text-white shadow-md shadow-primary/20 font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' ?>">
            <svg class="w-5 h-5 <?= strpos($_SERVER['REQUEST_URI'], '/owner/tasks/') !== false ? 'text-white' : 'text-gray-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
            <span>Task Engine</span>
        </a>
        <?php endif; ?>

        <a href="#" class="flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-900 mb-1">

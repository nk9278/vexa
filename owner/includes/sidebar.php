...
<aside id="mobile-drawer" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 transform -translate-x-full lg:translate-x-0 lg:static lg:flex lg:flex-col transition-transform duration-300 ease-in-out shadow-sm">
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="<?= BASE_URL ?>owner/crm/" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg <?= $current_dir === 'crm' ? 'bg-indigo-50 text-indigo-600' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' ?> transition-colors mb-1">
            <svg class="w-5 h-5 mr-3 <?= $current_dir === 'crm' ? 'text-indigo-600' : 'text-slate-400' ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            CRM Workspace
        </a>
        <?php endif; ?>

...
<div class="min-h-screen w-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-50">
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 class="mt-4 text-2xl font-bold text-slate-900">System Maintenance</h2>
        <p class="mt-2 text-sm text-slate-600">We are currently performing scheduled maintenance to improve your experience. We will be back shortly.</p>
    </div>
</div>
